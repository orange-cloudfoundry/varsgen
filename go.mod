...
require (
	...
	github.com/cloudfoundry/bosh-davcli v0.0.46 // indirect
	github.com/cloudfoundry/bosh-gcscli v0.0.20 // indirect
	github.com/cloudfoundry/bosh-s3cli v0.0.99 // indirect
	github.com/cloudfoundry/bosh-utils v0.0.286 // indirect
	github.com/cloudfoundry/config-server v0.1.27 // indirect
